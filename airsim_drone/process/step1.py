...
def filter_masks_by_semantic(predictions, metadata, allow_list, block_list, min_area):
    """
...
def step1(metadata, predictions, min_area):
    ...
    # 允许无人机降落的类别
    allow_list = {
        "floor", "grass", "road, route", "sidewalk, pavement", "table", "desk", "rug",
        # "chair"
    }
    # 不允许无人机降落的类别
    block_list = {
        ...
        "bag", "box", "bulletin board", "lamp", "pot", "tv", "cushion", "mirror", "shelf",
        "painting, picture", "plant", "blind, screen"
        "book"
    }
